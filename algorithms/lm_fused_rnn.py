...
class Seq2SeqBasenet(nn.Module):
    ...
    def active_inference(self, src, beam_width=3, max_tgt_sz=50):
...
class Seq2SeqLMCoupled(nn.Module):
    def __init__(self, encoder, decoder, lm_decoder,
                    pass_enc2dec_hid=False, dropout = 0, device = "cpu"):
        super(Seq2Seq, self).__init__()
